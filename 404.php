    ...
    <div class="c-main__wrapper">
        <section class="error-404 not-found">
            <header class="page-header">
                <span style="font-size: 2.5rem;"><?php esc_html_e('404 ERROR', 'holo') ?></span>
            ...
            <div class="page-content">
                ...
                <p style="margin: 3rem 0 4rem;">
                    <a href="<?php echo esc_url(home_url()); ?>" class="c-btn c-btn--secondary"><?php esc_html_e('Homepage', 'holo') ?></a>
                </p>

                <div class="o-grid">
                    <div class="o-col-12_md-5">
                        <div class="c-widget widget_search">
                            <h3><?php esc_html_e('Search for:' , 'holo'); ?></h3>
					        <?php get_search_form(); ?>
                        </div>
                    </div>
                </div>
