    ...
    <header id="masthead" class="c-header js-header">
        ...
        <div class="c-header__search js-header-search">
            <button aria-label="<?php esc_attr_e( 'Search',
				'wp-notes' ); ?>" class="c-header__link c-header__link--search js-search-btn">
        ...
        <nav id="site-navigation" class="c-header__nav">
            ...
            <div class="c-header__nav__wrapper">
                <button aria-label="<?php esc_attr_e( 'Menu close',
					'wp-notes' ); ?>" class="c-header__link c-header__link--menu c-header__link--menu-close js-menu-btn js-menu-btn--close">
