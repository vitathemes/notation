<form role="search" method="get" class="c-search-form search-form" action="<?php echo esc_url(home_url('/')); ?>">
	<label class="c-search-form__label">
		...
		<input type="search" class="c-search-form__label__field search-field" placeholder="<?php esc_attr_e('Search …', 'notation') ?>" value="<?php echo get_search_query(); ?>" name="s">
	</label>
	<button aria-label="<?php esc_attr_e('Submit', 'notation'); ?>" class="c-search-form__submit js-search-form-btn" type="submit">
